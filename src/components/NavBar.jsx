...
const Navbar = () => {
  ...
  return (
    <nav className="sticky z-[100] h-16 inset-x-0 top-0 w-full border-b border-gray-200 bg-white backdrop:blur-lg transition-all">
      {!isAuthenticated && (
        <div className="flex h-16 items-center justify-end border-b border-zinc-200 px-20">
      ...
      {isAuthenticated && (
        <div className="flex h-16 items-center justify-between border-b border-zinc-200 px-20">
